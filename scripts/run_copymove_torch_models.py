...
from luc_forgery_pipeline.config import COPYMOVE_MODEL_NAMES, ExperimentConfig, FORENSIC_MODEL_NAMES
from luc_forgery_pipeline.torch_train import train_one_torch_model


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train BusterNet/CMFDFormer/DOA-GAN style copy-move baselines.")
    ...
    parser.add_argument("--models", nargs="+", default=list(COPYMOVE_MODEL_NAMES), choices=list(FORENSIC_MODEL_NAMES))
