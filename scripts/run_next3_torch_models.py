...
from luc_forgery_pipeline.config import PYTORCH_MODEL_NAMES, ExperimentConfig
from luc_forgery_pipeline.torch_train import train_one_torch_model


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train SegFormer-B0, DeepLabV3+, and DINOv2 segmentation models.")
    ...
    parser.add_argument("--models", nargs="+", default=list(PYTORCH_MODEL_NAMES), choices=list(PYTORCH_MODEL_NAMES))
