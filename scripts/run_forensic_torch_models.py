...
from luc_forgery_pipeline.config import FORENSIC_MODEL_NAMES, ExperimentConfig, TRACE_MODEL_NAMES
from luc_forgery_pipeline.torch_train import train_one_torch_model


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train ManTra-Net/MVSS-Net style forensic segmentation baselines.")
    ...
    parser.add_argument("--models", nargs="+", default=list(TRACE_MODEL_NAMES), choices=list(FORENSIC_MODEL_NAMES))
